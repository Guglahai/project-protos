...
func (x *DeleteTaskResponse) GetDone() bool {
	if x != nil {
		return x.Done
	}
	return false
...
const file_proto_task_task_proto_rawDesc = "" +
	...
	"\x0fListTaskRequest\"2\n" +
	"\x10ListTaskResponse\x12\x1e\n" +
	...
	"\x12DeleteTaskResponse\x12\x12\n" +
	"\x04done\x18\x01 \x01(\bR\x04done2\xc4\x02\n" +
	"\vTaskService\x12?\n" +
	"\n" +
	...
	"\tListTasks\x12\x15.task.ListTaskRequest\x1a\x16.task.ListTaskResponse\x12?\n" +
	"\n" +
	"UpdateTask\x12\x17.task.UpdateTaskRequest\x1a\x18.task.UpdateTaskResponse\x12?\n" +
	"\n" +
	"DeleteTask\x12\x17.task.DeleteTaskRequest\x1a\x18.task.DeleteTaskResponseB/Z-github.com/Guglahai/project-protos/proto/taskb\x06proto3"
...
var file_proto_task_task_proto_depIdxs = []int32{
	...
	0,  // 2: task.ListTaskResponse.task:type_name -> task.Task
	...
	5,  // 7: task.TaskService.ListTasks:input_type -> task.ListTaskRequest
	...
	6,  // 12: task.TaskService.ListTasks:output_type -> task.ListTaskResponse
